...
method preInstall {
	...
	my 	$packagename 		= $self->opsinfo()->package();
...
method postInstall ($installdir, $version) {
	...
	$self->createAppFiles($owner, $packagename, $installdir, $apptypes, $paramtypes, $appdir, $bindir, $files);
	...
	$self->loadAppFiles($username, $packagename, $installdir, $appdir, $format);
...
method createAppFiles ($owner, $packagename, $installdir, $apptypes, $paramtypes, $appdir, $bindir, $files) {
	require Agua::CLI::App;
